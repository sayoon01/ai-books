...
### 1-1. 제조계열별 집계 (toprun / woosung)

| 제조계열 | 사출기수 | 가동금형수 | 총사이클 | NORMAL | NORMAL% | NO_SIGNAL% | 센서에러율 |
|---|---|---|---|---|---|---|---|
| toprun | 9 | 98 | 3,109,137 | 330,802 | 10.64% | 88.92% | 89.12% |
| woosung | 6 | 24 | 211,445 | 57,096 | 27.0% | 64.53% | 69.65% |

### 1-2. 도입연도별 집계

| 도입연도 | 사출기수 | 총사이클 | NORMAL | NORMAL% | NO_SIGNAL% |
|---|---|---|---|---|---|
